...
(function (root) {
  ...
  const QUOTES = [
    ...
    {
      t: "I'm not a great programmer; I'm just a good programmer with great habits.",
      a: "Kent Beck",
    },
    { t: "TDD is not about testing; it's about design.", a: "Kent Beck" },
    {
      t: "First make the change easy, then make the easy change.",
      a: "Kent Beck",
    },
    {
    ...
    {
      t: "Refactoring is a controlled technique for improving the design of an existing code base.",
      a: "Martin Fowler",
    },
    { t: "The only way to go fast is to go well.", a: "Robert C. Martin" },
    {
      t: "Truth can only be found in one place: the code.",
      a: "Robert C. Martin",
    },
    {
      t: "Continuous delivery is the ability to get changes of all types into production safely and quickly in a sustainable way.",
      a: "Dave Farley",
    },
    {
      t: "Software engineering is the application of an empirical, scientific approach to finding efficient, economic solutions to practical problems in software.",
      a: "Dave Farley",
    },
    {
      t: "Clean code always looks like it was written by someone who cares.",
      a: "Robert C. Martin",
    },
    {
  ...
  const PHASES = [
      ...
      weeks: [
        {
          id: "w1",
          n: 1,
          title: "Java Sharpening & Tooling Setup",
          tasks: [
        ...
        },
        {
          id: "w4",
          n: 4,
          title: "Mocking, Stubs & Testing Patterns",
          tasks: [
    ...
    },
    {
      id: "p2",
      num: "Phase 2",
      name: "Spring Boot & The Backend Craft",
      range: "Weeks 5–9",
      color: "#0EA5E9",
      boss: {
      ...
      weeks: [
        ...
        },
        {
          id: "w7",
          n: 7,
          title: "Databases — JPA, Hibernate & SQL",
          tasks: [
        ...
        },
        {
          id: "w8",
          n: 8,
          title: "Testing the Spring Stack",
          tasks: [
    ...
    },
    {
      ...
      weeks: [
        ...
        },
        {
          id: "w14",
          n: 14,
          title: "Cloud Fundamentals & System Design",
          tasks: [
    ...
    },
    {
      id: "p4",
      num: "Phase 4",
      name: "Pair Programming & Consultancy Polish",
      range: "Weeks 15–20",
      color: "#F97316",
      boss: {
        title: "Full Consultancy Mock Interview — All 4 Rounds",
        desc: "Run a complete consultancy-style mock: tech screen, pairing, consultancy chat and architecture deep dive.",
      },
      weeks: [
        {
          id: "w15",
          n: 15,
          title: "The Art of Pair Programming (Part 1)",
          tasks: [
        ...
        },
        {
          id: "w16",
          n: 16,
          title: "The Art of Pair Programming (Part 2)",
          tasks: [
        ...
        },
        {
          id: "w17",
          n: 17,
          title: "Consultancy Mindset (Part 1)",
          tasks: [
        ...
        },
        {
          id: "w18",
          n: 18,
          title: "Consultancy Mindset (Part 2)",
          tasks: [
        ...
        },
        {
          id: "w19",
          n: 19,
          title: "Architecture Deep Dives (Part 1)",
          tasks: [
        ...
        },
        {
          id: "w20",
          n: 20,
          title: "Architecture Deep Dives (Part 2)",
          tasks: [
    ...
    },
    {
      id: "p5",
      num: "Phase 5",
      name: "Portfolio, Application & Final Sprint",
      range: "Weeks 21–24",
      color: "#EF4444",
      boss: {
      ...
      weeks: [
        ...
        },
        {
          id: "w24",
          n: 24,
          title: "Application & Final Preparation",
          tasks: [
            "Deep-read your target consultancy's blog + careers page",
            "Pluralsight: Salary Negotiation",
            "Submit application + tailored cover letter",
            "Watch senior-consultancy talks/podcasts on YouTube",
          ],
        },
      ],
    },
  ...
  function isWeekComplete(state, weekId) {
    return !!(
      ...
      state.progress[weekId].complete
    );
  }
  ...
  function totalBadgesEarned(state) {
    return state && Array.isArray(state.achievements)
  ...
  const BADGES = [
    {
      ...
      name: "Red Light",
      icon: "🔴",
      desc: "Wrote your first failing test.",
      check: (s) => isWeekComplete(s, "w2"),
    },
    {
      id: "greenLight",
      name: "Green Light",
      icon: "🟢",
      desc: "Made the failing test pass.",
      check: (s) => isWeekComplete(s, "w2"),
    },
    {
      id: "refactor",
      name: "Refactor Hero",
      icon: "🛠️",
      desc: "Cleaned it up without breaking it.",
      check: (s) => isWeekComplete(s, "w3"),
    },
    {
      id: "cart",
      name: "Cart Conqueror",
      icon: "🛒",
      desc: "Phase 1 boss defeated.",
      check: (s) => !!(s && s.bossBattles && s.bossBattles.p1),
    },
    {
      id: "api",
      name: "API Architect",
      icon: "🌐",
      desc: "Phase 2 boss defeated.",
      check: (s) => !!(s && s.bossBattles && s.bossBattles.p2),
    },
    {
      id: "whale",
      name: "Whale Whisperer",
      icon: "🐳",
      desc: "Tamed Docker. Week 11 complete.",
      check: (s) => isWeekComplete(s, "w11"),
    },
    {
      id: "pipeline",
      name: "Pipeline Pro",
      icon: "⚙️",
      desc: "Shipped a CI pipeline. Week 13 complete.",
      check: (s) => isWeekComplete(s, "w13"),
    },
    {
      id: "pair",
      name: "Pair Magician",
      icon: "🧙",
      desc: "Pair programming, mastered.",
      check: (s) => isWeekComplete(s, "w16"),
    },
    {
      id: "consultant",
      name: "Consultant Voice",
      icon: "🎙️",
      desc: "Speaks fluent client.",
      check: (s) => isWeekComplete(s, "w18"),
    },
    {
      id: "offerEarned",
      name: "Offer Earned",
      icon: "👑",
      desc: "All 24 weeks. All 5 bosses. The offer.",
      check: (s) => allDone(s),
    },
  ];
  ...
  function nextStreak(prevStreak, prevLastCheckIn, todayDateStr) {
    ...
    if (diff === 1)
      return { streak: prevStreak + 1, lastCheckIn: todayDateStr };
